...
ESX.SavePlayer = function(xPlayer, cb)
  ...
  --             if(v.item ==  xPlayer.inventory[i].name) then
  --               v.count = xPlayer.inventory[i].count
  --             end
  --           end
  --           -- MySQL.Async.execute(
  --           --  'UPDATE user_inventory SET items = @items WHERE identifier = @identifier',
  --           --  {
  --           --    ['@identifier'] = xPlayer.getIdentifier(),
  ...
  table.insert(asyncTasks, function(cb) 
    MySQL.Async.execute( 
       ...
       { 
         ['@identifier'] = xPlayer.getIdentifier(), 
         ['@items']       = json.encode(xPlayer.inventory) 
       }, 
       function(rowsChanged) 
         cb() 
       end 
